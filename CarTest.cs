...
namespace ExpediaTest
{
	...
	{	
        ...
        [Test()]
        public void TestGetCorrectMileageFromDatabase()
        {
            IDatabase mockDatabase = mocks.Stub<IDatabase>();
        ...
        [Test()]
        public void TestObjectMotherInitializes()
        {
            Assert.IsNotNull(ObjectMother.Saab());
        }

        [Test()]
        public void TestCorrectPriceForObjectMother()
        {
            var car = ObjectMother.Saab();
            Assert.AreEqual(10*7*.8, car.getBasePrice());
        }
	}
}
